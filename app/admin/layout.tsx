          ...
          <div className="h-full px-4 lg:px-6 flex items-center justify-between">
            ...
            <div className="flex-shrink-0 flex items-center gap-2">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  <div className="w-7 h-7 rounded-full bg-gradient-to-br from-amber-500 to-amber-700 flex items-center justify-center text-xs font-medium text-white shadow-sm">
                    {userInitial}
                  </div>
