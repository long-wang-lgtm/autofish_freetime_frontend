...
interface StepAccountsProps {
  accounts: Account[]
  onStart: (description: string, accountUids: string[], taskId: string) => void
}

export function StepAccounts({ accounts, onStart }: StepAccountsProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4">
        ...
        <textarea
          ...
          placeholder="请粘贴要改写的商品描述..."
          rows={6}
          className="w-full p-3 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"
        />
      </div>
