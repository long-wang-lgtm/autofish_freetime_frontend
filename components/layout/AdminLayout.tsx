          ...
          <div className="h-full px-3 lg:px-6 flex items-center justify-between">
            ...
            <div className="flex-shrink-0 flex items-center gap-1.5 lg:gap-2">
              <button
                ...
                className="flex items-center gap-1 lg:gap-1.5 px-2 lg:px-3 py-1.5 text-xs lg:text-sm font-medium text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
              >
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="flex items-center gap-1.5 lg:gap-2 px-1.5 lg:px-2 py-1 lg:py-1.5 rounded-lg hover:bg-gray-100 transition-colors"
                >
