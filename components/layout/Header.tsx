      ...
      <div className="h-full px-3 lg:px-6 max-lg:[@media(max-height:500px)]:px-2 flex items-center justify-between">
        ...
        {isAdminRole(user?.role) && (
          <button
            ...
            className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors mr-2"
            title="管理员"
          >
        ...
        <div className="flex-shrink-0 relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center gap-1.5 lg:gap-2 max-lg:[@media(max-height:500px)]:gap-1 px-1.5 py-1 lg:px-2 lg:py-1.5 max-lg:[@media(max-height:500px)]:px-1 max-lg:[@media(max-height:500px)]:py-0.5 rounded-lg hover:bg-gray-100 transition-colors max-lg:min-h-11 max-lg:[@media(max-height:500px)]:min-h-10"
          >
            {/* 头像 */}
        ...
        {isAdminRole(user?.role) ? (
          ...
          >
            <div className="w-6 h-6 rounded-md bg-blue-600 flex items-center justify-center">
              <span className="text-xs font-bold text-white">逸</span>
            </div>
          </button>
        ) : (
